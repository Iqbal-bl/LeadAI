...
from social_agent.context import resolve_page_id

from .client import graph_delete, graph_get, graph_post


def _page_id() -> str:
    """The Facebook Page id of the company bound to this request.

    Resolved from the active credentials context rather than from the process
    environment — see social_agent/context.py for why.
    """
    return resolve_page_id()
