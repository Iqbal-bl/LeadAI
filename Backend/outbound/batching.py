...
from core.database import get_dynamic_db, get_db_from_headers

from outbound.repositories.BatchExecutionRepository import BatchExecutionRepository
from outbound.repositories.BatchLogsRepository import BatchLogsRepository
from outbound.repositories.CallNumberExecutionRepository import CallNumberExecutionRepository

from core.websocket_manager import manager  # websocket broadcasting

from outbound.bot.batch_level_csv_created import finalize_batch_with_csv
import logging
import logging
...
# Constants / defaults
# ------------------------------
from core.paths import BASE_DIR, TEMP_DIR as _TEMP_DIR
    ...
    async def start_batch(
        ...
        try:
            ...
            if script_path and not os.path.isabs(script_path):
                script_path = os.path.join(str(BASE_DIR), script_path)
